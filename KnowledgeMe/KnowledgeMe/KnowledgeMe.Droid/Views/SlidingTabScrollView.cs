...
using Android.Util;
using KnowledgeMe.Views;
using KnowledgeMe.Views.KnowledgeMe.Droid.Views;

namespace KnowledgeMe.Droid.Views
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        private ViewSwitcher mViewPager;
        private ViewSwitcher.IOnLayoutChangeListener mViewPagerPageChangeListener;
        ...
        public ViewSwitcher.IOnLayoutChangeListener OnPageListener
        {
            set { mViewPagerPageChangeListener = value; }
        }

        public ViewSwitcher ViewPager
        {
            set
            {
