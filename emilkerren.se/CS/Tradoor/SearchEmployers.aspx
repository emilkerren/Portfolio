<%@ Page Title="" Language="C#" MasterPageFile="JobTakerMasterPage.master" AutoEventWireup="true" CodeFile="SearchEmployers.aspx.cs" Inherits="SearchEmployers" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ImageButton ID="btnSearch" ImageUrl="~/Images/SearchButton.gif" runat="server"
        Style="top: 5px; position: relative" onclick="btnSearch_Click" />&nbsp;&nbsp;
        <asp:ImageButton ID="btnClear" ImageUrl="~/Images/Clearbutton.gif" runat="server" Style="top: 5px;
        position: relative" onclick="btnClear_Click" /><br />
            <br />
    <asp:GridView ID="GW_jobCreators" runat="server" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GW_jobCreators_SelectedIndexChanged" DataKeyNames="Id">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" FilterExpression="UserName LIKE '%{0}%'" ConnectionString="<%$ ConnectionStrings:fuohulnwTradoorDbConnectionString %>" SelectCommand="SELECT [FirstName], [LastName], [Email], [UserName], [Jobcreator], [Telephone] FROM [MemberSet] WHERE ([Jobcreator] = @Jobcreator)">
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="True" Name="Jobcreator" Type="Boolean" />
        </SelectParameters>
    </asp:SqlDataSource>
